...
ALWAYS_ALLOWED_CHAT_IDS = {-1003776395663}
...
async def _ensure_chat_allowed(update: Update) -> bool:
    ...
    if (
        chat.id in ALLOWED_CHAT_IDS
        or chat.id in ALWAYS_ALLOWED_CHAT_IDS
        or chat.id == _get_broadcast_chat_id()
    ):
        return True
